...
;;;
;;; dot-plus expression: match the rest of the input file.
;;;
;;; dot-plus <- .+
;;;
(define (dot-plus)
  (let ((genturfahi-.+ (genturfahi* (nunjavni-.+))))
    (dot-plus-test genturfahi-.+)))

(define (dot-plus-peg)
  (let* ((samselpla (call-with-input-file "dot-plus.peg" genturfahi-peg))
